          ...
          <div class="schedule-list">
            ${t.map(t=>B`
              <div class="schedule-entry">
                ...
                <button class="remove-btn" @click=${()=>this._removeScheduleEntry(t.day_number,t.start)}>
