    ...
    `:B`<ha-card><div class="error">Entity ${this._config.entity} not found</div></ha-card>`}_renderStatus(){const t=this._battery,e=this._activity,s=this._isRaining;return B`
      <div class="status-section">
        <div class="status-row">
          ...
          `:W}
          ${s?B`<span class="rain"><ha-icon icon="mdi:weather-rainy"></ha-icon> Rain</span>`:W}
        </div>
      </div>
    `}_renderControls(){const t=this._entity?.state||"",e="paused"===t;return B`
      ...
      <div class="schedule-section">
        ...
        `:B`
          <div class="schedule-list">
            ${t.map(t=>{const e=`${t.day_number}-${t.start}`,s=this._pendingRemove===e;return B`
              <div class="schedule-entry ${s?"removing":""}">
                ...
                ${t.edge?B`<span class="entry-edge-label">Edge</span>`:W}
                <button class="remove-btn" @click=${()=>this._removeScheduleEntry(t.day_number,t.start)} ?disabled=${s}>
                  ${s?B`<ha-icon icon="mdi:loading" class="spin"></ha-icon>`:B`<ha-icon icon="mdi:delete"></ha-icon>`}
                </button>
              </div>
            `})}
          </div>
