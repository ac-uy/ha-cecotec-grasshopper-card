 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ct={attribute:!0,type:String,converter:m,reflect:!1,hasChanged:$},ht=(t=ct,e,s)=>{const{kind:i,metadata:r}=s;let n=globalThis.litPropertyMetadata.get(r);if(void 0===n&&globalThis.litPropertyMetadata.set(r,n=new Map),"setter"===i&&((t=Object.create(t)).wrapped=!0),n.set(s.name,t),"accessor"===i){const{name:i}=s;return{set(s){const r=e.get.call(this);e.set.call(this,s),this.requestUpdate(i,r,t,!0,s)},init(e){return void 0!==e&&this.C(i,void 0,t,e),e}}}if("setter"===i){const{name:i}=s;return function(s){const r=this[i];e.call(this,s),this.requestUpdate(i,r,t,!0,s)}}throw Error("Unsupported decorator location: "+i)};
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
    ...
    `}_renderControls(){const t=this._entity?.state||"",e="docked"===t||"idle"===t,s="paused"===t,i=this._mowingMode;return F`
      <div class="controls-section">
        ${e?F`
          ...
          <button class="ctrl-btn ctrl-btn--mode ${"edge"===i?"ctrl-btn--mode-active":""}" @click=${this._toggleMode}>
            <ha-icon icon="mdi:${"edge"===i?"border-all-variant":"grass"}"></ha-icon>
            ${"edge"===i?"Edge":"Normal"}
          </button>
        `:s?F`
          <button class="ctrl-btn ctrl-btn--start" @click=${this._startMowing}>
