          ...
          <div class="schedule-list">
            ${t.map(t=>B`
              <div class="schedule-entry">
                ...
                ${t.edge?B`<ha-icon icon="mdi:border-all-variant" class="entry-edge"></ha-icon>`:W}
